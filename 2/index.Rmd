---
title: "Les essentiels de l'ouverture des données"
subtitle: "Open Data Days"
author: "Samuel Goëta, Datactivist"
date: "Marseille, `r format(Sys.Date(), '%d %b %Y')`"
output:
...
params:
  event: Les essentiels de l'ouverture des données
  slug: opendatadays/2/
---
...
.reduite[.center[![](img/800px-Démocratie_Ouverte.png)]]
...
---
### Un exemple de données granulaires

[![](img/granu.png)](https://accidents-route.fr/?x=43.30385453831537&y=5.369779999999991&z=15)
---
class: middle, center
...
[![](img/coronavirus.png)](https://gisanddata.maps.arcgis.com/apps/opsdashboard/index.html#/bda7594740fd40299423467b48e9ecf6)
...
---
### Des données inexploitables : le nombre de flashs aux radars

.middle[
.pull-left[
[![](img/radar1.png)](https://teamopendata.org/t/demande-de-donnees-a-des-administrations/1082/6)
]
.pull-right[
[![](./img/radars.png)](https://www.data.gouv.fr/fr/datasets/radars-automatiques-bilans-annuels-du-nombre-de-flashs/)
]
]
---
class: middle, center
...
.reduite[.center[
[![](./img/guide.png)](https://www.cnil.fr/sites/default/files/atoms/files/guide-open-data.pdf)
]]
...
---
### Encore un autre exemple de données introuvables (une passion personnelle)
...
![](http://www.opendatafrance.net/wp-content/uploads/2019/06/Affiche_opendata-01.png)
---
